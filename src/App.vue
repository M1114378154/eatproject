      ...
      <ul class="nav_list">
        <li class="active">
          ...
          <ul class="offset_left">
            <li>
              <router-link class="approu1" to="/category">分类区</router-link>
            </li>
            <li>
              <router-link class="approu1" to="/VideoGroup">视频专区</router-link>
            </li>
          </ul>
        </li>
        <li class="">
        ...
        <li class="">
          <router-link class="approu" to="/Foodstrategy">美食攻略</router-link>  
        </li>
        <li class="">
